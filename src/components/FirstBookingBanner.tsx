  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative m-[2px] rounded-[14px] bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 px-5 py-4 overflow-hidden">
          {/* Animated background elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-3xl animate-pulse" />
            <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-fuchsia-400/20 rounded-full blur-3xl animate-pulse delay-500" />
